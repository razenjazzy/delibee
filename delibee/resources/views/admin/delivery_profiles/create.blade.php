...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route'=>['admin.delivery_profiles.store'],'method' => 'post','class'=>'form-horizontal form-label-left', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="reward" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('reward')) parsley-error @endif"
                           name="reward" required value="{{old('reward')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="status" name="type" class="select2" style="width: 100%" autocomplete="off">
                        <option @if(old('type') && old('type') == 'fixed') selected @endif value="fixed">Fixed</option>
                        <option @if(old('type') && old('type') == 'percent') selected @endif value="percent">Percent</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="expires_at" type="date" class="form-control col-md-7 col-xs-12 @if($errors->has('expires_at')) parsley-error @endif"
                           name="expires_at" required value="{{old('expires_at')}}">
